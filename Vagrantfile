...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mnalepa-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/pqm"
  #   chef.validation_client_name = "pqm-validator"
  #   chef.validation_key_path = ".chef/pqm-validator.pem"
  # end
end
